...
<head>
    <meta charset="utf-8">
    <title>FAM - Online Service Provider for your House Needs</title>
                            ...
                            @if(Auth::user()->utype==='ADM')  
                                <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('admin.service_providers') }}">All Service Provider</a></li>
                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">kelompok5@gmail.com</a>
                            </li>
                            <li>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="social mlist-h">
                            <li class="facebook"><span><i class="fa fa-facebook"></i></span><a href="#"></a></li>
                            <li class="twitter"><span><i class="fa fa-twitter"></i></span><a href="#"></a></li>
                            <li class="instagram"><span><i class="fa fa-instagram"></i></span><a href="https://www.instagram.com/mahbuub_/"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 Kelompok 5. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
